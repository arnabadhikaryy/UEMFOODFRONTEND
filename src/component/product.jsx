          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-0">
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-between">
              <div>
                ...
                {/* Quantity & Controls */}
                <div className="flex flex-col sm:flex-row sm:items-center text-amber-950 justify-between gap-6 mb-8">
                  <div>
                  ...
                  <div className="text-right hidden sm:block">
                    <p className="text-sm text-amber-950 mb-1">Total Amount</p>
              ...
              >
                {loading ? (
                  <div className="flex items-center text-amber-950 justify-center space-x-2">
                  ...
                  <div className="flex justify-between text-amber-950 items-center w-full px-2">
