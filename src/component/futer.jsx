      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold">UEM Food</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/menu" className="text-gray-300 hover:text-white text-sm">
                  Menu
                </Link>
              </li>
              <li>
                <Link to="/orderhistory" className="text-gray-300 hover:text-white text-sm">
                  Your Orders
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li className="flex items-start">
                ...
                University Area, New Town, Kolkata
              </li>
          ...
          <div className="space-y-4">
            ...
            <form className="mt-2 flex">
              <input
                ...
                className="px-4 py-2 w-full rounded-l-md focus:outline-none text-white text-sm bg-black"
                required
              />
              <button
                type="submit"
                className="bg-blue-600 hover:bg-blue-700 text-black px-4 py-2 rounded-r-md text-sm font-medium"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 text-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()} UEM Food. All rights reserved.</p>
